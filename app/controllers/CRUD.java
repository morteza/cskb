 ...
 *        File: CRUD.java
 *    Revision: 1
 * Description: Modified version the default CRUD module from Play!.
...
public abstract class CRUD extends Controller {
    ...
    /**
     * A custom static function expected to return a string describes the entity.
     * It must be implemented inside the respective controllers.
     * This string will be shown inside a box on the CRUD.index page.
     * @return
     */
